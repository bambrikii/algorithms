...
import org.bambrikii.examples.graphs.rbtree.AbstractRbTree;
import org.bambrikii.examples.graphs.rbtree.RBColorEnum;
import org.bambrikii.examples.graphs.rbtree.RBNode;
import org.bambrikii.examples.graphs.rbtree2.utils.RotationDecoratorFactory;
...
//        }
	...
	public void delete(T val) {
		...
		if (z.getLeft() != null && z.getRight() != null) {
			throw new IllegalArgumentException("Can delete node " + z + " that has at most one child set!");
		}
