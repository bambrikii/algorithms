...
import org.bambrikii.examples.sorting.quick.QuickSortLastElementAsPivot;
...
public class SortAlgosTest {
    ...
    @Test
    public void testQuickSortLastElementAsPivot() throws SortingException {
        runAlgo(new QuickSortLastElementAsPivot(), array);
    }
    ...
    @Test
    public void testMergeSort2() throws SortingException {
        runAlgo(new MergeSort2(), array);
    }
}
